...
function FeedbackForm() {
    ...
    const validateForm = ()=>{
        ...
        else if(!em_value.includes('.ac.in')||(!em_value.includes('@'))){
            document.getElementById('email_er').style.display = "block";
                        ...
                        <Row>
                            <Col>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    ...
                                    <Form.Control type="text" required placeholder="E.g. jhon snow" value={nm_value} onChange={e => setNmValue(e.target.value)} />
                            ...
                            <Col>
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    ...
                                    <Form.Control type="email" required placeholder="E.g. abc@infosys.ac.in" value={em_value} onChange={e => setEmValue(e.target.value)}/>
                                </Form.Group>
